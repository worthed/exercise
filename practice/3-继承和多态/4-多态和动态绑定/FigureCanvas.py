...
class FigureCanvas(Canvas):  #扩展自tkinter.Canvas
    #FigureCanvas类的初始化方法调用Canvas的初始化放啊，
    # 设置数据域的figureType和filled属性，然后调用frawFigure来绘制一个图形
    ...
    def drawFigure(self): #drawFigure方法利用figureType和filled属性来绘制一个推行
